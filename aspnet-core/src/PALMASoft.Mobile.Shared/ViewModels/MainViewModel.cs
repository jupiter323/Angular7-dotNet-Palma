...
using MvvmHelpers;
using PALMASoft.Authorization.Users.Profile;
using PALMASoft.Authorization.Users.Profile.Dto;
using PALMASoft.Commands;
using PALMASoft.Core.Threading;
using PALMASoft.Models.NavigationMenu;
using PALMASoft.Services.Navigation;
using PALMASoft.ViewModels.Base;
using Plugin.Media;
...
using PALMASoft.Controls;
using PALMASoft.Dto;
using PALMASoft.Extensions;
using PALMASoft.Localization;
using PALMASoft.UI;
using PALMASoft.UI.Assets;
using PALMASoft.Views;
using DependencyResolver = PALMASoft.Core.Dependency.DependencyResolver;

namespace PALMASoft.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PALMASoft";
