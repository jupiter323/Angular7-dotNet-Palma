...
namespace PALMASoft.Migrations
{
    ...
    [Migration("20190316180030_Regenerated_AFoliar9634")]
    partial class Regenerated_AFoliar9634
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PALMASoft.AFoliares.AFoliar", b =>
                {
                    ...
                    b.Property<long?>("AnalisisId_FoliId");

                    b.Property<long>("AnalisisId_Foliar");
            ...
            modelBuilder.Entity("PALMASoft.ASuelos.ASuelo", b =>
                {
                    ...
                    b.Property<long?>("AnalisisId_SuelId");

                    b.Property<long>("AnalisisId_Suelos");
            ...
            modelBuilder.Entity("PALMASoft.Clientes.Cliente", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("CELULAR_CLIENTE");

                    b.Property<DateTime>("CreationTime");

                    b.Property<long?>("CreatorUserId");

                    b.Property<string>("DEPARTAMENTO_CLIENTE");
                    ...
                    b.Property<DateTime?>("FECHA_CLIENTE");

                    b.Property<int>("GENERO_CLIENTE");
                    ...
                    b.Property<string>("MUNICIPIO_CLIENTE");

                    b.Property<string>("NOMBRE_CLIENTE")
                        .HasMaxLength(36);

                    b.Property<string>("PROFESION_CLIENTE");
            ...
            modelBuilder.Entity("PALMASoft.Departamentos.Departamento", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PALMASoft.Municipios.Municipio", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("ID_MUNICIPIO")
                        .IsRequired()
                        .HasMaxLength(12);
            ...
            modelBuilder.Entity("PALMASoft.Paises.Pais", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PALMASoft.AFoliares.AFoliar", b =>
                {
                    b.HasOne("PALMASoft.Analises.Analisis", "AnalisisId_Foli")
                        .WithMany()
                        .HasForeignKey("AnalisisId_FoliId");
                });

            modelBuilder.Entity("PALMASoft.ASuelos.ASuelo", b =>
                {
                    b.HasOne("PALMASoft.Analises.Analisis", "AnalisisId_Suel")
                        .WithMany()
                        .HasForeignKey("AnalisisId_SuelId");
                });
            ...
            modelBuilder.Entity("PALMASoft.Departamentos.Departamento", b =>
                {
                    b.HasOne("PALMASoft.Paises.Pais", "Pais")
                        .WithMany()
            ...
            modelBuilder.Entity("PALMASoft.Municipios.Municipio", b =>
                {
                    b.HasOne("PALMASoft.Departamentos.Departamento", "Departamento")
                        .WithMany()
