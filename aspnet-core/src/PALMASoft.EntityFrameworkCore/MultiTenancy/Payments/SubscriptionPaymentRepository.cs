...
using PALMASoft.EntityFrameworkCore.Repositories;

namespace PALMASoft.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : PALMASoftRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PALMASoftDbContext> dbContextProvider)
