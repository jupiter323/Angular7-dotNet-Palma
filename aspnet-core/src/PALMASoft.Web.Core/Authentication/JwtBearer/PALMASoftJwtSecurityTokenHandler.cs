...
namespace PALMASoft.Web.Authentication.JwtBearer
{
    public class PALMASoftJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PALMASoftJwtSecurityTokenHandler()
        {
