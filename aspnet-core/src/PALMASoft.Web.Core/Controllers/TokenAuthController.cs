...
using PALMASoft.Web.Authentication.TwoFactor;
using PALMASoft.Web.Models.TokenAuth;
using PALMASoft.Authorization.Impersonation;
using PALMASoft.Identity;
using PALMASoft.Notifications;
using PALMASoft.Web.Authentication.External;

namespace PALMASoft.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : PALMASoftControllerBase
    {
