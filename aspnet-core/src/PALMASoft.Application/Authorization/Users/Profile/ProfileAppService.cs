...
using PALMASoft.Authentication.TwoFactor.Google;
using PALMASoft.Authorization.Users.Dto;
using PALMASoft.Authorization.Users.Profile.Cache;
using PALMASoft.Authorization.Users.Profile.Dto;
using PALMASoft.Friendships;
using PALMASoft.Gdpr;
using PALMASoft.Identity;
using PALMASoft.Security;
using PALMASoft.Storage;
using PALMASoft.Timing;

namespace PALMASoft.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PALMASoftAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PALMASoft",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PALMASoft",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
