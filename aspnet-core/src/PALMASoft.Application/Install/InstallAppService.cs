...
using PALMASoft.Migrations.Seed.Host;
...
namespace PALMASoft.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PALMASoftAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PALMASoftDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PALMASoftConsts.ConnectionStringName).Value.ToString();
        }
