...
using PALMASoft.DemoUiComponents.Dto;

namespace PALMASoft.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PALMASoftAppServiceBase, IDemoUiComponentsAppService
    {
