...
namespace PALMASoft.Web.Public.Startup
{
    ...
    public class PALMASoftWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PALMASoftWebFrontEndModule(IHostingEnvironment env, PALMASoftEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PALMASoftWebFrontEndModule).GetAssembly());
        }
    }
}
