...
using PALMASoft.Url;
using PALMASoft.Web.Public.Startup;
using PALMASoft.Web.Session;

namespace PALMASoft.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PALMASoftViewComponent
    {
