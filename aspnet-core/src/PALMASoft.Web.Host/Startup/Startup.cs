...
using PALMASoft.Install;
using PALMASoft.MultiTenancy;
using PALMASoft.Web.Authentication.JwtBearer;
using PALMASoft.Web.Chat.SignalR;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using Swashbuckle.AspNetCore.Swagger;
using PALMASoft.Web.IdentityServer;
using PALMASoft.Web.Startup.Swagger;
using PALMASoft.Web.Swagger;
using Newtonsoft.Json.Linq;
using Stripe;
using ILogger = Microsoft.Extensions.Logging.ILogger;
using ILoggerFactory = Microsoft.Extensions.Logging.ILoggerFactory;

namespace PALMASoft.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "PALMASoft API", Version = "v1" });
            ...
            return services.AddAbp<PALMASoftWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "PALMASoft API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("PALMASoft.Web.wwwroot.swagger.ui.index.html");
