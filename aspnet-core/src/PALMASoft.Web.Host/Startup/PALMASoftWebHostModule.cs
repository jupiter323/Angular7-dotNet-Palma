...
{
    [DependsOn(
        typeof(PALMASoftWebCoreModule)
    )]
    public class PALMASoftWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PALMASoftWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PALMASoftWebHostModule).GetAssembly());
        }
