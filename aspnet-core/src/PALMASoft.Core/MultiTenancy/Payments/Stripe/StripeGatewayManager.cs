...
namespace PALMASoft.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : PALMASoftServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PALMASoft";
        ...
        public async Task<StripeIdResponse> CreateCharge(string source, decimal amount, string description)
        {
            ...
            var charge = await chargeService.CreateAsync(new ChargeCreateOptions
            {
                ...
                Currency = PALMASoftConsts.Currency,
                Capture = true
            });
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PALMASoftConsts.Currency;
        }
