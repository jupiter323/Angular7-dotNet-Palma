...
using PALMASoft.MultiTenancy.Demo;
...
namespace PALMASoft.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PALMASoftConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
