...
export class ClientesServiceProxy {
     ...
     * @param iD_CLIENTEFilter (optional) 
     * @param nOMBRE_CLIENTEFilter (optional) 
     * @param aPELLIDO_CLIENTEFilter (optional) 
     * @param gENERO_CLIENTEFilter (optional) 
     * @param maxFECHA_CLIENTEFilter (optional) 
     * @param minFECHA_CLIENTEFilter (optional) 
     * @param cELULAR_CLIENTEFilter (optional) 
     * @param dIRECCION_CLIENTEFilter (optional) 
     * @param dEPARTAMENTO_CLIENTEFilter (optional) 
     * @param mUNICIPIO_CLIENTEFilter (optional) 
     * @param eMPRESA_CLIENTEFilter (optional) 
     * @param pROFESION_CLIENTEFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | null | undefined, iD_CLIENTEFilter: string | null | undefined, nOMBRE_CLIENTEFilter: string | null | undefined, aPELLIDO_CLIENTEFilter: string | null | undefined, gENERO_CLIENTEFilter: number | null | undefined, maxFECHA_CLIENTEFilter: moment.Moment | null | undefined, minFECHA_CLIENTEFilter: moment.Moment | null | undefined, cELULAR_CLIENTEFilter: string | null | undefined, dIRECCION_CLIENTEFilter: string | null | undefined, dEPARTAMENTO_CLIENTEFilter: string | null | undefined, mUNICIPIO_CLIENTEFilter: string | null | undefined, eMPRESA_CLIENTEFilter: string | null | undefined, pROFESION_CLIENTEFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetClienteForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Clientes/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_CLIENTEFilter !== undefined)
            url_ += "ID_CLIENTEFilter=" + encodeURIComponent("" + iD_CLIENTEFilter) + "&"; 
        if (nOMBRE_CLIENTEFilter !== undefined)
            url_ += "NOMBRE_CLIENTEFilter=" + encodeURIComponent("" + nOMBRE_CLIENTEFilter) + "&"; 
        if (aPELLIDO_CLIENTEFilter !== undefined)
            url_ += "APELLIDO_CLIENTEFilter=" + encodeURIComponent("" + aPELLIDO_CLIENTEFilter) + "&"; 
        if (gENERO_CLIENTEFilter !== undefined)
            url_ += "GENERO_CLIENTEFilter=" + encodeURIComponent("" + gENERO_CLIENTEFilter) + "&"; 
        if (maxFECHA_CLIENTEFilter !== undefined)
            url_ += "MaxFECHA_CLIENTEFilter=" + encodeURIComponent(maxFECHA_CLIENTEFilter ? "" + maxFECHA_CLIENTEFilter.toJSON() : "") + "&"; 
        if (minFECHA_CLIENTEFilter !== undefined)
            url_ += "MinFECHA_CLIENTEFilter=" + encodeURIComponent(minFECHA_CLIENTEFilter ? "" + minFECHA_CLIENTEFilter.toJSON() : "") + "&"; 
        if (cELULAR_CLIENTEFilter !== undefined)
            url_ += "CELULAR_CLIENTEFilter=" + encodeURIComponent("" + cELULAR_CLIENTEFilter) + "&"; 
        if (dIRECCION_CLIENTEFilter !== undefined)
            url_ += "DIRECCION_CLIENTEFilter=" + encodeURIComponent("" + dIRECCION_CLIENTEFilter) + "&"; 
        if (dEPARTAMENTO_CLIENTEFilter !== undefined)
            url_ += "DEPARTAMENTO_CLIENTEFilter=" + encodeURIComponent("" + dEPARTAMENTO_CLIENTEFilter) + "&"; 
        if (mUNICIPIO_CLIENTEFilter !== undefined)
            url_ += "MUNICIPIO_CLIENTEFilter=" + encodeURIComponent("" + mUNICIPIO_CLIENTEFilter) + "&"; 
        if (eMPRESA_CLIENTEFilter !== undefined)
            url_ += "EMPRESA_CLIENTEFilter=" + encodeURIComponent("" + eMPRESA_CLIENTEFilter) + "&"; 
        if (pROFESION_CLIENTEFilter !== undefined)
            url_ += "PROFESION_CLIENTEFilter=" + encodeURIComponent("" + pROFESION_CLIENTEFilter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetClienteForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetClienteForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetClienteForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetClienteForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetClienteForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetClienteForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getClienteForView(id: number | null | undefined): Observable<GetClienteForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Clientes/GetClienteForView?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetClienteForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetClienteForView(<any>response_);
                } catch (e) {
                    return <Observable<GetClienteForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetClienteForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetClienteForView(response: HttpResponseBase): Observable<GetClienteForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetClienteForViewDto.fromJS(resultData200) : new GetClienteForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetClienteForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getClienteForEdit(id: number | null | undefined): Observable<GetClienteForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Clientes/GetClienteForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetClienteForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetClienteForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetClienteForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetClienteForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetClienteForEdit(response: HttpResponseBase): Observable<GetClienteForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetClienteForEditOutput.fromJS(resultData200) : new GetClienteForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetClienteForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditClienteDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Clientes/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getClientesToExcel(filter: string | null | undefined, iD_CLIENTEFilter: string | null | undefined, nOMBRE_CLIENTEFilter: string | null | undefined, aPELLIDO_CLIENTEFilter: string | null | undefined, gENERO_CLIENTEFilter: number | null | undefined, maxFECHA_CLIENTEFilter: moment.Moment | null | undefined, minFECHA_CLIENTEFilter: moment.Moment | null | undefined, cELULAR_CLIENTEFilter: string | null | undefined, dIRECCION_CLIENTEFilter: string | null | undefined, dEPARTAMENTO_CLIENTEFilter: string | null | undefined, mUNICIPIO_CLIENTEFilter: string | null | undefined, eMPRESA_CLIENTEFilter: string | null | undefined, pROFESION_CLIENTEFilter: string | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Clientes/GetClientesToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_CLIENTEFilter !== undefined)
            url_ += "ID_CLIENTEFilter=" + encodeURIComponent("" + iD_CLIENTEFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetClientesToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetClientesToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetClientesToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class DepartamentosServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param filter (optional) 
     * @param iD_DEPARTAMENTOFilter (optional) 
     * @param nOMBRE_DEPARTAMENTOFilter (optional) 
     * @param paisNOMBRE_PAISFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | null | undefined, iD_DEPARTAMENTOFilter: string | null | undefined, nOMBRE_DEPARTAMENTOFilter: string | null | undefined, paisNOMBRE_PAISFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetDepartamentoForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_DEPARTAMENTOFilter !== undefined)
            url_ += "ID_DEPARTAMENTOFilter=" + encodeURIComponent("" + iD_DEPARTAMENTOFilter) + "&"; 
        if (nOMBRE_DEPARTAMENTOFilter !== undefined)
            url_ += "NOMBRE_DEPARTAMENTOFilter=" + encodeURIComponent("" + nOMBRE_DEPARTAMENTOFilter) + "&"; 
        if (paisNOMBRE_PAISFilter !== undefined)
            url_ += "PaisNOMBRE_PAISFilter=" + encodeURIComponent("" + paisNOMBRE_PAISFilter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetDepartamentoForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetDepartamentoForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetDepartamentoForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetDepartamentoForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetDepartamentoForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetDepartamentoForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getDepartamentoForView(id: number | null | undefined): Observable<GetDepartamentoForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/GetDepartamentoForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDepartamentoForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDepartamentoForView(<any>response_);
                } catch (e) {
                    return <Observable<GetDepartamentoForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetDepartamentoForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetDepartamentoForView(response: HttpResponseBase): Observable<GetDepartamentoForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetDepartamentoForViewDto.fromJS(resultData200) : new GetDepartamentoForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetDepartamentoForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getDepartamentoForEdit(id: number | null | undefined): Observable<GetDepartamentoForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/GetDepartamentoForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDepartamentoForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDepartamentoForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetDepartamentoForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetDepartamentoForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetDepartamentoForEdit(response: HttpResponseBase): Observable<GetDepartamentoForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetDepartamentoForEditOutput.fromJS(resultData200) : new GetDepartamentoForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetDepartamentoForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditDepartamentoDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getDepartamentosToExcel(filter: string | null | undefined, iD_DEPARTAMENTOFilter: string | null | undefined, nOMBRE_DEPARTAMENTOFilter: string | null | undefined, paisNOMBRE_PAISFilter: string | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/GetDepartamentosToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_DEPARTAMENTOFilter !== undefined)
            url_ += "ID_DEPARTAMENTOFilter=" + encodeURIComponent("" + iD_DEPARTAMENTOFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDepartamentosToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDepartamentosToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetDepartamentosToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllPaisForLookupTable(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfPaisLookupTableDto> {
        let url_ = this.baseUrl + "/api/services/app/Departamentos/GetAllPaisForLookupTable?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllPaisForLookupTable(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllPaisForLookupTable(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfPaisLookupTableDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfPaisLookupTableDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllPaisForLookupTable(response: HttpResponseBase): Observable<PagedResultDtoOfPaisLookupTableDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfPaisLookupTableDto.fromJS(resultData200) : new PagedResultDtoOfPaisLookupTableDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfPaisLookupTableDto>(<any>null);
    }
}
...
@Injectable()
export class FincasServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param filter (optional) 
     * @param iD_FINCAFilter (optional) 
     * @param nOMBRE_FINCAFilter (optional) 
     * @param dEPARTAMENTO_FINCAFilter (optional) 
     * @param mUNICIPIO_FINCAFilter (optional) 
     * @param vEREDA_FINCAFilter (optional) 
     * @param cORREGIMIENTO_FINCAFilter (optional) 
     * @param uBICACION_FINCAFilter (optional) 
     * @param lONGITUD_FINCAFilter (optional) 
     * @param lATITUD_FINCAFilter (optional) 
     * @param cONTACTO_FINCAFilter (optional) 
     * @param tELEFONO_FINCAFilter (optional) 
     * @param cORREO_FINCAFilter (optional) 
     * @param clienteNOMBRE_CLIENTEFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | null | undefined, iD_FINCAFilter: string | null | undefined, nOMBRE_FINCAFilter: string | null | undefined, dEPARTAMENTO_FINCAFilter: string | null | undefined, mUNICIPIO_FINCAFilter: string | null | undefined, vEREDA_FINCAFilter: string | null | undefined, cORREGIMIENTO_FINCAFilter: string | null | undefined, uBICACION_FINCAFilter: string | null | undefined, lONGITUD_FINCAFilter: string | null | undefined, lATITUD_FINCAFilter: string | null | undefined, cONTACTO_FINCAFilter: string | null | undefined, tELEFONO_FINCAFilter: string | null | undefined, cORREO_FINCAFilter: string | null | undefined, clienteNOMBRE_CLIENTEFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetFincaForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_FINCAFilter !== undefined)
            url_ += "ID_FINCAFilter=" + encodeURIComponent("" + iD_FINCAFilter) + "&"; 
        if (nOMBRE_FINCAFilter !== undefined)
            url_ += "NOMBRE_FINCAFilter=" + encodeURIComponent("" + nOMBRE_FINCAFilter) + "&"; 
        if (dEPARTAMENTO_FINCAFilter !== undefined)
            url_ += "DEPARTAMENTO_FINCAFilter=" + encodeURIComponent("" + dEPARTAMENTO_FINCAFilter) + "&"; 
        if (mUNICIPIO_FINCAFilter !== undefined)
            url_ += "MUNICIPIO_FINCAFilter=" + encodeURIComponent("" + mUNICIPIO_FINCAFilter) + "&"; 
        if (vEREDA_FINCAFilter !== undefined)
            url_ += "VEREDA_FINCAFilter=" + encodeURIComponent("" + vEREDA_FINCAFilter) + "&"; 
        if (cORREGIMIENTO_FINCAFilter !== undefined)
            url_ += "CORREGIMIENTO_FINCAFilter=" + encodeURIComponent("" + cORREGIMIENTO_FINCAFilter) + "&"; 
        if (uBICACION_FINCAFilter !== undefined)
            url_ += "UBICACION_FINCAFilter=" + encodeURIComponent("" + uBICACION_FINCAFilter) + "&"; 
        if (lONGITUD_FINCAFilter !== undefined)
            url_ += "LONGITUD_FINCAFilter=" + encodeURIComponent("" + lONGITUD_FINCAFilter) + "&"; 
        if (lATITUD_FINCAFilter !== undefined)
            url_ += "LATITUD_FINCAFilter=" + encodeURIComponent("" + lATITUD_FINCAFilter) + "&"; 
        if (cONTACTO_FINCAFilter !== undefined)
            url_ += "CONTACTO_FINCAFilter=" + encodeURIComponent("" + cONTACTO_FINCAFilter) + "&"; 
        if (tELEFONO_FINCAFilter !== undefined)
            url_ += "TELEFONO_FINCAFilter=" + encodeURIComponent("" + tELEFONO_FINCAFilter) + "&"; 
        if (cORREO_FINCAFilter !== undefined)
            url_ += "CORREO_FINCAFilter=" + encodeURIComponent("" + cORREO_FINCAFilter) + "&"; 
        if (clienteNOMBRE_CLIENTEFilter !== undefined)
            url_ += "ClienteNOMBRE_CLIENTEFilter=" + encodeURIComponent("" + clienteNOMBRE_CLIENTEFilter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetFincaForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetFincaForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetFincaForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetFincaForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetFincaForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetFincaForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getFincaForView(id: number | null | undefined): Observable<GetFincaForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/GetFincaForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFincaForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFincaForView(<any>response_);
                } catch (e) {
                    return <Observable<GetFincaForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetFincaForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetFincaForView(response: HttpResponseBase): Observable<GetFincaForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetFincaForViewDto.fromJS(resultData200) : new GetFincaForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetFincaForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getFincaForEdit(id: number | null | undefined): Observable<GetFincaForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/GetFincaForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFincaForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFincaForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetFincaForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetFincaForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetFincaForEdit(response: HttpResponseBase): Observable<GetFincaForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetFincaForEditOutput.fromJS(resultData200) : new GetFincaForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetFincaForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditFincaDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getFincasToExcel(filter: string | null | undefined, iD_FINCAFilter: string | null | undefined, nOMBRE_FINCAFilter: string | null | undefined, dEPARTAMENTO_FINCAFilter: string | null | undefined, mUNICIPIO_FINCAFilter: string | null | undefined, vEREDA_FINCAFilter: string | null | undefined, cORREGIMIENTO_FINCAFilter: string | null | undefined, uBICACION_FINCAFilter: string | null | undefined, lONGITUD_FINCAFilter: string | null | undefined, lATITUD_FINCAFilter: string | null | undefined, cONTACTO_FINCAFilter: string | null | undefined, tELEFONO_FINCAFilter: string | null | undefined, cORREO_FINCAFilter: string | null | undefined, clienteNOMBRE_CLIENTEFilter: string | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/GetFincasToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_FINCAFilter !== undefined)
            url_ += "ID_FINCAFilter=" + encodeURIComponent("" + iD_FINCAFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFincasToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFincasToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetFincasToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllClienteForLookupTable(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfClienteLookupTableDto> {
        let url_ = this.baseUrl + "/api/services/app/Fincas/GetAllClienteForLookupTable?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllClienteForLookupTable(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllClienteForLookupTable(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfClienteLookupTableDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfClienteLookupTableDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllClienteForLookupTable(response: HttpResponseBase): Observable<PagedResultDtoOfClienteLookupTableDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfClienteLookupTableDto.fromJS(resultData200) : new PagedResultDtoOfClienteLookupTableDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfClienteLookupTableDto>(<any>null);
    }
}
...
@Injectable()
export class MunicipiosServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param filter (optional) 
     * @param iD_MUNICIPIOFilter (optional) 
     * @param nOMBRE_MUNICIPIOFilter (optional) 
     * @param departamentoNOMBRE_DEPARTAMENTOFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | null | undefined, iD_MUNICIPIOFilter: string | null | undefined, nOMBRE_MUNICIPIOFilter: string | null | undefined, departamentoNOMBRE_DEPARTAMENTOFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetMunicipioForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_MUNICIPIOFilter !== undefined)
            url_ += "ID_MUNICIPIOFilter=" + encodeURIComponent("" + iD_MUNICIPIOFilter) + "&"; 
        if (nOMBRE_MUNICIPIOFilter !== undefined)
            url_ += "NOMBRE_MUNICIPIOFilter=" + encodeURIComponent("" + nOMBRE_MUNICIPIOFilter) + "&"; 
        if (departamentoNOMBRE_DEPARTAMENTOFilter !== undefined)
            url_ += "DepartamentoNOMBRE_DEPARTAMENTOFilter=" + encodeURIComponent("" + departamentoNOMBRE_DEPARTAMENTOFilter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetMunicipioForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetMunicipioForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetMunicipioForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetMunicipioForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetMunicipioForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetMunicipioForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getMunicipioForView(id: number | null | undefined): Observable<GetMunicipioForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/GetMunicipioForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMunicipioForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMunicipioForView(<any>response_);
                } catch (e) {
                    return <Observable<GetMunicipioForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetMunicipioForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetMunicipioForView(response: HttpResponseBase): Observable<GetMunicipioForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetMunicipioForViewDto.fromJS(resultData200) : new GetMunicipioForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetMunicipioForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getMunicipioForEdit(id: number | null | undefined): Observable<GetMunicipioForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/GetMunicipioForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMunicipioForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMunicipioForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetMunicipioForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetMunicipioForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetMunicipioForEdit(response: HttpResponseBase): Observable<GetMunicipioForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetMunicipioForEditOutput.fromJS(resultData200) : new GetMunicipioForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetMunicipioForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditMunicipioDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getMunicipiosToExcel(filter: string | null | undefined, iD_MUNICIPIOFilter: string | null | undefined, nOMBRE_MUNICIPIOFilter: string | null | undefined, departamentoNOMBRE_DEPARTAMENTOFilter: string | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/GetMunicipiosToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_MUNICIPIOFilter !== undefined)
            url_ += "ID_MUNICIPIOFilter=" + encodeURIComponent("" + iD_MUNICIPIOFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMunicipiosToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMunicipiosToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetMunicipiosToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllDepartamentoForLookupTable(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfDepartamentoLookupTableDto> {
        let url_ = this.baseUrl + "/api/services/app/Municipios/GetAllDepartamentoForLookupTable?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllDepartamentoForLookupTable(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllDepartamentoForLookupTable(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfDepartamentoLookupTableDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfDepartamentoLookupTableDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllDepartamentoForLookupTable(response: HttpResponseBase): Observable<PagedResultDtoOfDepartamentoLookupTableDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDepartamentoLookupTableDto.fromJS(resultData200) : new PagedResultDtoOfDepartamentoLookupTableDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfDepartamentoLookupTableDto>(<any>null);
    }
}
...
@Injectable()
export class PaisesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param filter (optional) 
     * @param iD_PAISFilter (optional) 
     * @param nOMBRE_PAISFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | null | undefined, iD_PAISFilter: string | null | undefined, nOMBRE_PAISFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfGetPaisForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Paises/GetAll?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_PAISFilter !== undefined)
            url_ += "ID_PAISFilter=" + encodeURIComponent("" + iD_PAISFilter) + "&"; 
        if (nOMBRE_PAISFilter !== undefined)
            url_ += "NOMBRE_PAISFilter=" + encodeURIComponent("" + nOMBRE_PAISFilter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetPaisForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetPaisForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetPaisForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfGetPaisForViewDto.fromJS(resultData200) : new PagedResultDtoOfGetPaisForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetPaisForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getPaisForView(id: number | null | undefined): Observable<GetPaisForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Paises/GetPaisForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPaisForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPaisForView(<any>response_);
                } catch (e) {
                    return <Observable<GetPaisForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetPaisForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaisForView(response: HttpResponseBase): Observable<GetPaisForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetPaisForViewDto.fromJS(resultData200) : new GetPaisForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetPaisForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getPaisForEdit(id: number | null | undefined): Observable<GetPaisForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Paises/GetPaisForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPaisForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPaisForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetPaisForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetPaisForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaisForEdit(response: HttpResponseBase): Observable<GetPaisForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetPaisForEditOutput.fromJS(resultData200) : new GetPaisForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetPaisForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: CreateOrEditPaisDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Paises/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Paises/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getPaisesToExcel(filter: string | null | undefined, iD_PAISFilter: string | null | undefined, nOMBRE_PAISFilter: string | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Paises/GetPaisesToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (iD_PAISFilter !== undefined)
            url_ += "ID_PAISFilter=" + encodeURIComponent("" + iD_PAISFilter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPaisesToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPaisesToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetPaisesToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    importcsv(data: Object | null | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processImportcsv(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processImportcsv(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processImportcsv(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PagedResultDtoOfGetClienteForViewDto implements IPagedResultDtoOfGetClienteForViewDto {
    totalCount!: number | undefined;
    items!: GetClienteForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetClienteForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetClienteForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetClienteForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetClienteForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetClienteForViewDto {
    totalCount: number | undefined;
    items: GetClienteForViewDto[] | undefined;
}

export class GetClienteForViewDto implements IGetClienteForViewDto {
    cliente!: ClienteDto | undefined;

    constructor(data?: IGetClienteForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.cliente = data["cliente"] ? ClienteDto.fromJS(data["cliente"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetClienteForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetClienteForViewDto();
        result.init(data);
        return result;
    }
...
export interface IGetClienteForViewDto {
    cliente: ClienteDto | undefined;
}
...
export class ClienteDto implements IClienteDto {
    ...
    apellidO_CLIENTE!: string | undefined;
    generO_CLIENTE!: Generos | undefined;
    fechA_CLIENTE!: moment.Moment | undefined;
    celulaR_CLIENTE!: string | undefined;
    direccioN_CLIENTE!: string | undefined;
    departamentO_CLIENTE!: string | undefined;
    municipiO_CLIENTE!: string | undefined;
    empresA_CLIENTE!: string | undefined;
    profesioN_CLIENTE!: string | undefined;
    id!: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.generO_CLIENTE = data["generO_CLIENTE"];
            this.fechA_CLIENTE = data["fechA_CLIENTE"] ? moment(data["fechA_CLIENTE"].toString()) : <any>undefined;
            this.celulaR_CLIENTE = data["celulaR_CLIENTE"];
            this.direccioN_CLIENTE = data["direccioN_CLIENTE"];
            this.departamentO_CLIENTE = data["departamentO_CLIENTE"];
            this.municipiO_CLIENTE = data["municipiO_CLIENTE"];
            this.empresA_CLIENTE = data["empresA_CLIENTE"];
            this.profesioN_CLIENTE = data["profesioN_CLIENTE"];
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["nombrE_CLIENTE"] = this.nombrE_CLIENTE;
        data["apellidO_CLIENTE"] = this.apellidO_CLIENTE;
        data["generO_CLIENTE"] = this.generO_CLIENTE;
        data["fechA_CLIENTE"] = this.fechA_CLIENTE ? this.fechA_CLIENTE.toISOString() : <any>undefined;
        data["celulaR_CLIENTE"] = this.celulaR_CLIENTE;
        data["direccioN_CLIENTE"] = this.direccioN_CLIENTE;
        data["departamentO_CLIENTE"] = this.departamentO_CLIENTE;
        data["municipiO_CLIENTE"] = this.municipiO_CLIENTE;
        data["empresA_CLIENTE"] = this.empresA_CLIENTE;
        data["profesioN_CLIENTE"] = this.profesioN_CLIENTE;
        data["id"] = this.id;
        return data; 
    }
}
...
export class GetClienteForEditOutput implements IGetClienteForEditOutput {
    cliente!: CreateOrEditClienteDto | undefined;

    constructor(data?: IGetClienteForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.cliente = data["cliente"] ? CreateOrEditClienteDto.fromJS(data["cliente"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetClienteForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetClienteForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetClienteForEditOutput {
    cliente: CreateOrEditClienteDto | undefined;
}

export class CreateOrEditClienteDto implements ICreateOrEditClienteDto {
    iD_CLIENTE!: string;
    nombrE_CLIENTE!: string | undefined;
    apellidO_CLIENTE!: string | undefined;
    generO_CLIENTE!: Generos | undefined;
    ...
    constructor(data?: ICreateOrEditClienteDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditClienteDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditClienteDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditClienteDto {
    iD_CLIENTE: string;
    nombrE_CLIENTE: string | undefined;
    apellidO_CLIENTE: string | undefined;
    generO_CLIENTE: Generos | undefined;
...
export class PagedResultDtoOfGetDepartamentoForViewDto implements IPagedResultDtoOfGetDepartamentoForViewDto {
    totalCount!: number | undefined;
    items!: GetDepartamentoForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetDepartamentoForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetDepartamentoForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetDepartamentoForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetDepartamentoForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetDepartamentoForViewDto {
    totalCount: number | undefined;
    items: GetDepartamentoForViewDto[] | undefined;
}

export class GetDepartamentoForViewDto implements IGetDepartamentoForViewDto {
    departamento!: DepartamentoDto | undefined;
    paisNOMBRE_PAIS!: string | undefined;

    constructor(data?: IGetDepartamentoForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.departamento = data["departamento"] ? DepartamentoDto.fromJS(data["departamento"]) : <any>undefined;
            this.paisNOMBRE_PAIS = data["paisNOMBRE_PAIS"];
        }
    }

    static fromJS(data: any): GetDepartamentoForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetDepartamentoForViewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["paisNOMBRE_PAIS"] = this.paisNOMBRE_PAIS;
        return data; 
    }
}

export interface IGetDepartamentoForViewDto {
    departamento: DepartamentoDto | undefined;
    paisNOMBRE_PAIS: string | undefined;
}
...
export class DepartamentoDto implements IDepartamentoDto {
    ...
    nombrE_DEPARTAMENTO!: string | undefined;
    ...
    toJSON(data?: any) {
        ...
        data["nombrE_DEPARTAMENTO"] = this.nombrE_DEPARTAMENTO;
...
export class GetDepartamentoForEditOutput implements IGetDepartamentoForEditOutput {
    departamento!: CreateOrEditDepartamentoDto | undefined;
    paisNOMBRE_PAIS!: string | undefined;

    constructor(data?: IGetDepartamentoForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.departamento = data["departamento"] ? CreateOrEditDepartamentoDto.fromJS(data["departamento"]) : <any>undefined;
            this.paisNOMBRE_PAIS = data["paisNOMBRE_PAIS"];
        }
    }

    static fromJS(data: any): GetDepartamentoForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetDepartamentoForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetDepartamentoForEditOutput {
    departamento: CreateOrEditDepartamentoDto | undefined;
    paisNOMBRE_PAIS: string | undefined;
}

export class CreateOrEditDepartamentoDto implements ICreateOrEditDepartamentoDto {
    iD_DEPARTAMENTO!: string;
    nombrE_DEPARTAMENTO!: string | undefined;
    paisId!: number | undefined;
    id!: number | undefined;

    constructor(data?: ICreateOrEditDepartamentoDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditDepartamentoDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditDepartamentoDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditDepartamentoDto {
    iD_DEPARTAMENTO: string;
    nombrE_DEPARTAMENTO: string | undefined;
    paisId: number | undefined;
    id: number | undefined;
...
export class PagedResultDtoOfPaisLookupTableDto implements IPagedResultDtoOfPaisLookupTableDto {
    totalCount!: number | undefined;
    items!: PaisLookupTableDto[] | undefined;

    constructor(data?: IPagedResultDtoOfPaisLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(PaisLookupTableDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfPaisLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfPaisLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfPaisLookupTableDto {
    totalCount: number | undefined;
    items: PaisLookupTableDto[] | undefined;
}

export class PaisLookupTableDto implements IPaisLookupTableDto {
    id!: number | undefined;
    displayName!: string | undefined;

    constructor(data?: IPaisLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PaisLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaisLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IPaisLookupTableDto {
    id: number | undefined;
    displayName: string | undefined;
}
...
export class PagedResultDtoOfGetFincaForViewDto implements IPagedResultDtoOfGetFincaForViewDto {
    totalCount!: number | undefined;
    items!: GetFincaForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetFincaForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetFincaForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetFincaForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetFincaForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetFincaForViewDto {
    totalCount: number | undefined;
    items: GetFincaForViewDto[] | undefined;
}

export class GetFincaForViewDto implements IGetFincaForViewDto {
    finca!: FincaDto | undefined;
    clienteNOMBRE_CLIENTE!: string | undefined;

    constructor(data?: IGetFincaForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.finca = data["finca"] ? FincaDto.fromJS(data["finca"]) : <any>undefined;
            this.clienteNOMBRE_CLIENTE = data["clienteNOMBRE_CLIENTE"];
        }
    }

    static fromJS(data: any): GetFincaForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetFincaForViewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["finca"] = this.finca ? this.finca.toJSON() : <any>undefined;
        data["clienteNOMBRE_CLIENTE"] = this.clienteNOMBRE_CLIENTE;
        return data; 
    }
}

export interface IGetFincaForViewDto {
    finca: FincaDto | undefined;
    clienteNOMBRE_CLIENTE: string | undefined;
}

export class FincaDto implements IFincaDto {
    iD_FINCA!: string | undefined;
    nombrE_FINCA!: string | undefined;
    departamentO_FINCA!: string | undefined;
    municipiO_FINCA!: string | undefined;
    veredA_FINCA!: string | undefined;
    corregimientO_FINCA!: string | undefined;
    ubicacioN_FINCA!: string | undefined;
    longituD_FINCA!: string | undefined;
    latituD_FINCA!: string | undefined;
    contactO_FINCA!: string | undefined;
    telefonO_FINCA!: string | undefined;
    correO_FINCA!: string | undefined;
    clienteId!: number | undefined;
    id!: number | undefined;

    constructor(data?: IFincaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.iD_FINCA = data["iD_FINCA"];
            this.nombrE_FINCA = data["nombrE_FINCA"];
            this.departamentO_FINCA = data["departamentO_FINCA"];
            this.municipiO_FINCA = data["municipiO_FINCA"];
            this.veredA_FINCA = data["veredA_FINCA"];
            this.corregimientO_FINCA = data["corregimientO_FINCA"];
            this.ubicacioN_FINCA = data["ubicacioN_FINCA"];
            this.longituD_FINCA = data["longituD_FINCA"];
            this.latituD_FINCA = data["latituD_FINCA"];
            this.contactO_FINCA = data["contactO_FINCA"];
            this.telefonO_FINCA = data["telefonO_FINCA"];
            this.correO_FINCA = data["correO_FINCA"];
            this.clienteId = data["clienteId"];
            this.id = data["id"];
        }
    }

    static fromJS(data: any): FincaDto {
        data = typeof data === 'object' ? data : {};
        let result = new FincaDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["iD_FINCA"] = this.iD_FINCA;
        data["nombrE_FINCA"] = this.nombrE_FINCA;
        data["departamentO_FINCA"] = this.departamentO_FINCA;
        data["municipiO_FINCA"] = this.municipiO_FINCA;
        data["veredA_FINCA"] = this.veredA_FINCA;
        data["corregimientO_FINCA"] = this.corregimientO_FINCA;
        data["ubicacioN_FINCA"] = this.ubicacioN_FINCA;
        data["longituD_FINCA"] = this.longituD_FINCA;
        data["latituD_FINCA"] = this.latituD_FINCA;
        data["contactO_FINCA"] = this.contactO_FINCA;
        data["telefonO_FINCA"] = this.telefonO_FINCA;
        data["correO_FINCA"] = this.correO_FINCA;
...
export class GetFincaForEditOutput implements IGetFincaForEditOutput {
    finca!: CreateOrEditFincaDto | undefined;
    clienteNOMBRE_CLIENTE!: string | undefined;

    constructor(data?: IGetFincaForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.finca = data["finca"] ? CreateOrEditFincaDto.fromJS(data["finca"]) : <any>undefined;
            this.clienteNOMBRE_CLIENTE = data["clienteNOMBRE_CLIENTE"];
        }
    }

    static fromJS(data: any): GetFincaForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetFincaForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetFincaForEditOutput {
    finca: CreateOrEditFincaDto | undefined;
    clienteNOMBRE_CLIENTE: string | undefined;
}

export class CreateOrEditFincaDto implements ICreateOrEditFincaDto {
    iD_FINCA!: string;
    nombrE_FINCA!: string | undefined;
    departamentO_FINCA!: string | undefined;
    municipiO_FINCA!: string | undefined;
    ...
    constructor(data?: ICreateOrEditFincaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditFincaDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditFincaDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditFincaDto {
    iD_FINCA: string;
    nombrE_FINCA: string | undefined;
    departamentO_FINCA: string | undefined;
    municipiO_FINCA: string | undefined;
...
export class PagedResultDtoOfClienteLookupTableDto implements IPagedResultDtoOfClienteLookupTableDto {
    totalCount!: number | undefined;
    items!: ClienteLookupTableDto[] | undefined;

    constructor(data?: IPagedResultDtoOfClienteLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(ClienteLookupTableDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfClienteLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfClienteLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfClienteLookupTableDto {
    totalCount: number | undefined;
    items: ClienteLookupTableDto[] | undefined;
}

export class ClienteLookupTableDto implements IClienteLookupTableDto {
    id!: number | undefined;
    displayName!: string | undefined;

    constructor(data?: IClienteLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ClienteLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new ClienteLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IClienteLookupTableDto {
    id: number | undefined;
    displayName: string | undefined;
}
...
export class PagedResultDtoOfGetMunicipioForViewDto implements IPagedResultDtoOfGetMunicipioForViewDto {
    totalCount!: number | undefined;
    items!: GetMunicipioForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetMunicipioForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetMunicipioForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetMunicipioForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetMunicipioForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetMunicipioForViewDto {
    totalCount: number | undefined;
    items: GetMunicipioForViewDto[] | undefined;
}

export class GetMunicipioForViewDto implements IGetMunicipioForViewDto {
    municipio!: MunicipioDto | undefined;
    departamentoNOMBRE_DEPARTAMENTO!: string | undefined;

    constructor(data?: IGetMunicipioForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.municipio = data["municipio"] ? MunicipioDto.fromJS(data["municipio"]) : <any>undefined;
            this.departamentoNOMBRE_DEPARTAMENTO = data["departamentoNOMBRE_DEPARTAMENTO"];
        }
    }

    static fromJS(data: any): GetMunicipioForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetMunicipioForViewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["departamentoNOMBRE_DEPARTAMENTO"] = this.departamentoNOMBRE_DEPARTAMENTO;
        return data; 
    }
}

export interface IGetMunicipioForViewDto {
    municipio: MunicipioDto | undefined;
    departamentoNOMBRE_DEPARTAMENTO: string | undefined;
}

export class MunicipioDto implements IMunicipioDto {
    iD_MUNICIPIO!: string | undefined;
    nombrE_MUNICIPIO!: string | undefined;
    ...
    toJSON(data?: any) {
        ...
        data["nombrE_MUNICIPIO"] = this.nombrE_MUNICIPIO;
...
export class GetMunicipioForEditOutput implements IGetMunicipioForEditOutput {
    municipio!: CreateOrEditMunicipioDto | undefined;
    departamentoNOMBRE_DEPARTAMENTO!: string | undefined;

    constructor(data?: IGetMunicipioForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.municipio = data["municipio"] ? CreateOrEditMunicipioDto.fromJS(data["municipio"]) : <any>undefined;
            this.departamentoNOMBRE_DEPARTAMENTO = data["departamentoNOMBRE_DEPARTAMENTO"];
        }
    }

    static fromJS(data: any): GetMunicipioForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetMunicipioForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetMunicipioForEditOutput {
    municipio: CreateOrEditMunicipioDto | undefined;
    departamentoNOMBRE_DEPARTAMENTO: string | undefined;
}

export class CreateOrEditMunicipioDto implements ICreateOrEditMunicipioDto {
    iD_MUNICIPIO!: string;
    nombrE_MUNICIPIO!: string | undefined;
    departamentoId!: number | undefined;
    id!: number | undefined;

    constructor(data?: ICreateOrEditMunicipioDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditMunicipioDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditMunicipioDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditMunicipioDto {
    iD_MUNICIPIO: string;
    nombrE_MUNICIPIO: string | undefined;
    departamentoId: number | undefined;
    id: number | undefined;
...
export class PagedResultDtoOfDepartamentoLookupTableDto implements IPagedResultDtoOfDepartamentoLookupTableDto {
    totalCount!: number | undefined;
    items!: DepartamentoLookupTableDto[] | undefined;

    constructor(data?: IPagedResultDtoOfDepartamentoLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(DepartamentoLookupTableDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfDepartamentoLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfDepartamentoLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfDepartamentoLookupTableDto {
    totalCount: number | undefined;
    items: DepartamentoLookupTableDto[] | undefined;
}

export class DepartamentoLookupTableDto implements IDepartamentoLookupTableDto {
    id!: number | undefined;
    displayName!: string | undefined;

    constructor(data?: IDepartamentoLookupTableDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DepartamentoLookupTableDto {
        data = typeof data === 'object' ? data : {};
        let result = new DepartamentoLookupTableDto();
        result.init(data);
        return result;
    }
...
export interface IDepartamentoLookupTableDto {
    id: number | undefined;
    displayName: string | undefined;
}
...
export class PagedResultDtoOfGetPaisForViewDto implements IPagedResultDtoOfGetPaisForViewDto {
    totalCount!: number | undefined;
    items!: GetPaisForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetPaisForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetPaisForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetPaisForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetPaisForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetPaisForViewDto {
    totalCount: number | undefined;
    items: GetPaisForViewDto[] | undefined;
}

export class GetPaisForViewDto implements IGetPaisForViewDto {
    pais!: PaisDto | undefined;

    constructor(data?: IGetPaisForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.pais = data["pais"] ? PaisDto.fromJS(data["pais"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetPaisForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetPaisForViewDto();
        result.init(data);
        return result;
    }
...
export interface IGetPaisForViewDto {
    pais: PaisDto | undefined;
}

export class PaisDto implements IPaisDto {
    iD_PAIS!: string | undefined;
    nombrE_PAIS!: string | undefined;
    id!: number | undefined;
    ...
    toJSON(data?: any) {
        ...
        data["nombrE_PAIS"] = this.nombrE_PAIS;
        data["id"] = this.id;
        return data; 
    }
}
...
export class GetPaisForEditOutput implements IGetPaisForEditOutput {
    pais!: CreateOrEditPaisDto | undefined;

    constructor(data?: IGetPaisForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.pais = data["pais"] ? CreateOrEditPaisDto.fromJS(data["pais"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetPaisForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetPaisForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetPaisForEditOutput {
    pais: CreateOrEditPaisDto | undefined;
}

export class CreateOrEditPaisDto implements ICreateOrEditPaisDto {
    iD_PAIS!: string;
    nombrE_PAIS!: string | undefined;
    id!: number | undefined;

    constructor(data?: ICreateOrEditPaisDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditPaisDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditPaisDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditPaisDto {
    iD_PAIS: string;
    nombrE_PAIS: string | undefined;
    id: number | undefined;
}
